...
// Why: same skew shape as kimi — polytoken grows the ensureAgentSession enum, so clients probe first.
export const AGENT_SESSION_POLYTOKEN_RESUME_RUNTIME_CAPABILITY =
  'agent-session.polytoken-resume.v1' as const
